export function generationStatusText(status, role) {
  ...
  let text = status.configured
    ? 'Luna enabled. Creating or reorganizing a draft sends its source text to OpenAI for your review. Saving, previewing and signing do not make a paid generation request.'
