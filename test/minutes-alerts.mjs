...
assert.equal(minutesReviewAlert({ id: 'one', meeting_date: '2026-09-03' }).title,
  'Meeting minutes awaiting your review: September 3, 2026');
...
assert.match(minutesCompletionAlert({ meeting_date: '2026-09-03' }).message, /Meeting Minutes, September 3, 2026/);
