...
try {
  ...
  console.log('Structured minutes callback, strict schema, source references, uncertainty, explicit paid-generation failure and local-only mode passed without a network call.');
} finally {
