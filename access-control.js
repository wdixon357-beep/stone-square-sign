...
const reader=['reports.create','minutes.view','treasury.view',...personal];
...
export function resolvePermissions(user){
 ...
 switch(user?.role){
 case 'secretary': return [...reader,'minutes.prepare','treasury.prepare','treasury.upload','dues.view','documents.status','documents.sign','candidates.view'];
 case 'assistant_secretary': return [...reader,'minutes.prepare','treasury.prepare','dues.view','documents.status','documents.sign','candidates.view'];
 case 'treasurer':return ['reports.create','treasury.view','treasury.prepare','treasury.upload','dues.view',...personal];
 case 'assistant_treasurer':case 'treasury_preparer':return ['reports.create','treasury.view','treasury.prepare','dues.view',...personal];
 case 'warden':return [...reader,'dues.view','documents.status','candidates.view','proposals.create'];
